...
export default function QCM() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {quizzes.map((quiz, idx) => (
              <motion.div 
                ...
                className="bg-white rounded-3xl border border-zinc-200 p-8 shadow-sm hover:shadow-md transition-all group flex flex-col h-full"
              >
                <div className="mb-6">
                ...
                <h3 className="text-xl font-bold text-zinc-900 mb-3 group-hover:text-blue-600 transition-colors">{quiz.title}</h3>
                <p className="text-sm text-zinc-500 mb-8 flex-grow leading-relaxed">{quiz.description}</p>
                <button 
                  onClick={() => startQuiz(quiz)}
                  className="w-full py-4 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-blue-600 transition-all flex items-center justify-center gap-2"
                >
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      >
        <h2 className="text-2xl font-bold text-zinc-900 mb-12 leading-tight">
